...
I've implemented a simple gRPC server and client with the following functionality:
- simple RPC
...
```bash
protoc --go_out=. --go_opt=module=github.com/LOVESH1808/basic-go-grpc --go-grpc_out=. --go-grpc_opt=module=githu
